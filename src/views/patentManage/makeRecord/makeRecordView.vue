      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="专利名称 :">
            <span v-text="form.cgPatent.patentName"></span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="预估价 :">
            <span v-text="form.cgPatent.estimatedPrice"></span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="申请号 :">
            <span v-text="form.cgPatent.applyNo"></span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="发明人 :">
            <span v-text="form.cgPatent.inventor"></span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="申请日 :">
            <span v-text="form.cgPatent.applyDate"></span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="申请人 :">
            <span v-text="form.cgPatent.applyPeople"></span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="公开号 :">
            <span v-text="form.cgPatent.publicNo"></span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="专利权人 :">
            <span v-text="form.cgPatent.patentee"></span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="公开日 :">
            <span v-text="form.cgPatent.publicDate"></span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="代理机构 :">
            <span v-text="form.cgPatent.agency"></span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="代理人 :">
            <span v-text="form.cgPatent.agencyPeople"></span>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
...
<script>
import { getmakeRecord } from "@/api/makeRecore";
  ...
  methods: {
    getmakeRecordData() {
      getmakeRecord(this.id).then((res) => {
        if (res.code === 0) {
          this.details = Base64.decode(res.cgClinch.cgPatent.details);
